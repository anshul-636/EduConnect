...
exports.markBulk = async (req, res) => { try { ok(res, await svc.markBulk(req.params.classId, req.body.date, req.body.records, req.user.id, req.user.role)); } catch (e) { err(res, e); } };
