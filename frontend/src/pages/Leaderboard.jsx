    ...
    <Layout>
      <div className='max-w-4xl mx-auto'>
        ...
        {loading ? <Loader /> : entries.length === 0 ? (
          <div className='text-center py-20 text-dark-500 reveal'>No scores recorded yet.</div>
        ) : (
          <div className='card overflow-hidden p-0 reveal delay-1'>
            <table className='w-full'>
              ...
              <tbody>
                {entries.map((e, i) => (
                  <tr key={e.id} className={`border-b border-dark-800 hover:bg-dark-800/50 transition-colors reveal-left delay-${Math.min((i % 8) + 1, 8)}`}>
